...
def create_button(frame, text, row, column, rowspan=1, columnspan=1, padx=30, pady=20,bg_color="white",active_bg="#829799"):
    button = Button(frame, 
                    text=text, 
                    padx=padx, 
                    pady=pady, 
...
main_frame = Frame(window, bg="blue", width=380, height=430)
main_frame.pack()
...
#creating buttons
create_button(main_frame, "C", 1, 0,padx=29,bg_color="#829799",active_bg="red")
create_button(main_frame, "/", 1, 1,bg_color="#829799")
create_button(main_frame, "*", 1, 2,bg_color="#829799")
create_button(main_frame, "-", 1, 3, padx=32,bg_color="#ffa705",active_bg="#ffa705")
...
create_button(main_frame, "+", 2, 3, rowspan=2, pady=53,bg_color="#ffa705",active_bg="#ffa705")
...
create_button(main_frame, "=", 4, 3, rowspan=2, pady=53,bg_color="#ffa705",active_bg="green")
...
create_button(main_frame, "%", 5, 0, padx=28,bg_color="#829799")
create_button(main_frame, "0", 5, 1,bg_color="#829799")
create_button(main_frame, ".", 5, 2, padx=32,bg_color="#829799")
